...
db_user = os.getenv("MYSQL_USER") or os.getenv("db_user") or st.secrets.get("MYSQL_USER")
db_password = os.getenv("MYSQL_PASSWORD") or os.getenv("db_password") or st.secrets.get("MYSQL_PASSWORD")
db_host = os.getenv("MYSQL_HOST") or os.getenv("db_host") or st.secrets.get("MYSQL_HOST")
db_name = os.getenv("MYSQL_DB") or os.getenv("db_name") or st.secrets.get("MYSQL_DB")
db_port = os.getenv("MYSQL_PORT") or os.getenv("db_port") or st.secrets.get("MYSQL_PORT")
...
def get_chain():
    ...
    print("Creating chain...")
    # Handle 'None' or empty ports gracefully inside get_chain
    if db_port and str(db_port).strip() != "None" and str(db_port).strip() != "":
    ...
    llm = ChatGoogleGenerativeAI(
        model="gemini-1.5-flash", google_api_key=GEMINI_API_KEY, temperature=0
    )
